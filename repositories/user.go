...
type UserRepository interface {
	...
	Register(ctx context.Context, register dto.Register) (models.Users, error)
}
...
func (u *userRepositoryImpl) Register(ctx context.Context, register dto.Register) (models.Users, error) {
	var (
		user models.Users
		db   = u.database.WithContext(ctx)
	)
